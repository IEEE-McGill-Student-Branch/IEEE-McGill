export const posts = [
...

	{
		...
		date: '2023-10-14',
		location: 'Polytechnique (UdeM)',
		shortDescription: 'Information about registration, prizes, and more!',
		content:
			'<p>IEEEXtreme 18.0 is orangized by the IEEE Montreal at Polytechnique from Friday evening to Saturday evening. The contest will be 24 hours, with sets of questions every few hours. </p>'
	},

	{
		...
		shortDescription: 'IEEE Annual Event with food and drinks',
		content: "<p>This post is about IEEE Banquet 2023</p>"
	}
];
